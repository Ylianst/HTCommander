...
- [Linux (.tar.gz)](https://github.com/Ylianst/HTCommander/releases/latest/download/htcommander-linux-x64.tar.gz) | [.deb](https://github.com/Ylianst/HTCommander/releases/latest/download/htcommander-linux-x64.deb) | [.rpm](https://github.com/Ylianst/HTCommander/releases/latest/download/htcommander-linux-x64.rpm) | [AppImage](https://github.com/Ylianst/HTCommander/releases/download/latest/htcommander-linux-x64.AppImage). Should work, please test and report.
