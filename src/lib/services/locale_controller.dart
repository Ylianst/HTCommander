...
/// `Language` key on device 0 (the same store used by the settings dialog).
  ...
  /// `fr`, `es`, `zh`, `ja`, `hi` or `de`. The active [Locale] is exposed as a [ValueNotifier] so that the
...
class LocaleController {
  ...
  static const List<String> supportedLanguageTags = ['en', 'fr', 'es', 'zh', 'ja', 'hi', 'de'];
  ...
  /// The persisted language tag (`system`, `en`, `fr`, `es`, `zh`, `ja`, `hi`, `de`, ...).
