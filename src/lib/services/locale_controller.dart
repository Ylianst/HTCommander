...
/// or `fr`. The active [Locale] is exposed as a [ValueNotifier] so that the
...
class LocaleController {
  ...
  static const List<String> supportedLanguageTags = ['en', 'fr'];
  ...
  /// The persisted language tag (`system`, `en`, `fr`, ...).
