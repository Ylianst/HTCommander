...
namespace HTCommander
{
    public partial class VoiceControl : UserControl
    {
        ...
        private float GetVoiceMessageHeight(VoiceMessage voiceMessage, Graphics g, VoiceMessage previousVoiceMessage)
        {
            ...
            if (!string.IsNullOrEmpty(voiceMessage.Route) && ((voiceMessage.Encoding == VoiceTextEncodingType.Recording) || (voiceMessage.Encoding == VoiceTextEncodingType.Ident) || (previousVoiceMessage == null) || (previousVoiceMessage.Route != voiceMessage.Route)))
            {
